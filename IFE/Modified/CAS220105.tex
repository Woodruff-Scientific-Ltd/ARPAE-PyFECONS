...
To cost the system in this report, these costs are scaled to the system power, 2502, with a learning credit applied due to the EoS gained by standardised manufacturing, and a consideration of the likely maximum PGA for the location the reactor is constructed in. The final costs are \$ 125 M for engineering and \$ 178 M for fabrication, totalling \$ 304 M for the subsystem in the specified region, assuming a PGA of 0 g.

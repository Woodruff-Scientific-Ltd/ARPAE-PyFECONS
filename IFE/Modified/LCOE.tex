...
\begin{table}[h!] 
\begin{tabular}{l c c } 
Net electric power & MW & 1145.711 \\
Plant availability & \% & 0.9 \\
Inflation & \% & 2.5 \\
Lifetime of plant & Years & 30 \\
Capital cost, $C_{AC}$ &     M\$/annum    &    799.3      \\ 
Operations and Maintenance Costs, $C_{OM}$ & M\$/annum  &      68.7 \\ 
Fuel Costs, $C_{F}$ & M\$/annum  &       16.4 \\ 
    \end{tabular} 
    \caption{Variables in the LCOE calculation.}
    \label{tab:lcoe} 
\end{table} 

Following equation \ref{eq:coe}, the LCOE is 108.0 \$/MWh or 10.8 c/kWh.

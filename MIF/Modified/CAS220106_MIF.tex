...
\begin{itemize}
    \item Gravity load. The vessel must support the 1 g force acting straight down on the entire vessel and the components it supports. The dominant masses are the vessel itself 289 tonnes, the total coil mass COILM tonnes, and auxiliary components inside and outside the vessel, 500 tonnes.
...
For the chamber geoemtry specified in Cost Category 22.01.02, a total material volume of 37 m$^3$ is calculated. ASTM A240 Type-304 stainless steel is used because it is nonmagnetic, has good fracture toughness and welding properties, is readily available and inexpensive, and a total mass of 289 tons is required, costing 0.6 M USD. Considering the manufacturing and assembly process, however, will increase the vessel cost significantly. One notable requirement is to polish the entire inner surface to maintain the required high vacuum, and reduce the risk of electrical faults. An approximate manufacturing factor of 10 is assumed for the entire process. This results in a cost for vacuum vessel of 6 M USD.\\
...
\begin{table}[h]
    ...
    \begin{tabular}{lc}
    \hline
        Vessel volume (m$^3$) & 266\\
        Material volume (m$^3$) & 37\\
        Material & ASTM A240 304 SS\\
        Material mass (tons) & 289\\
        Material cost (M USD) & 0.6\\
        Total cost (M USD) & 6 \\
         \hline
    \end{tabular}}
...
The costs for this subsystem are 6 M USD for the vacuum vessel, 0 M USD for the cooling systems, 3 M USD for the vacuum pumping systems, and 0.34 M USD for the roughing pump. The total cost is 9 M USD.\\
...
22.01.06.03 Primary Vacuum Pumps: consists of d a distributed vacuum subsystem with vacuum pumps located at each sector. For a vacuum of 7694 m$^3$, 1846 vacuum pumps will be required, costing 50 K USD each, corresponding to a total pumping system cost of 3 M USD.\\

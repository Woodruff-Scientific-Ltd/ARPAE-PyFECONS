...
\hline
Magnet Type & magnetType1 & magnetType2 \\
Radius (m) & rCentre1 & rCentre2 \\
dr (m) & dr1 & dr2 \\
dz (m) & dz1 & dz2 \\
Current supply (MA) & currentSupply1 & currentSupply2 \\
Conductor current density (A/mm$^2$) & jTape1 & jTape2 \\
Cable width (m) & cableW1 & cableW2 \\
Cable height (m) & cableH1 & cableH2 \\
Total volume (m$^3$) & volCoil1 & volCoil2 \\
Cross-sectional area (m$^2$) & csArea1 & csArea2 \\
Turn-turn Insulation Fraction & fracIns1 & fracIns2 \\
\hline
Cable turns & turnsC1 & turnsC2 \\
Total turns of conductor & turnsScTot1 & turnsScTot2 \\
Length of conductor (km) & tapeLength1 & tapeLength2 \\
Current per conductor (A) & tapeCurrent1 & tapeCurrent2 \\
\hline
Cost of REBCO tape(\$/kAm) & mCostYBCO & mCostYBCO \\
Cost of SC (M USD) & costSC1 & costSC2 \\
Cost of copper (M USD) & costCu1 & costCu2 \\
Cost of SS (M USD) & costSS1 & costSS2 \\
Cost of other turn-turn insulation (M USD) & costI1 & costI2 \\
Total material cost (M USD) & totMatCost1 & totMatCost2 \\
Manufacturing factor & mfrFactor1 & mfrFactor2 \\
Structural cost (M USD) & SolenoidStructCost & M1StructCost \\
Quantity & noSolenoidCoils & noM1Coils \\
Magnet cost (single)(M USD) & SolenoidMagCost & M1MagCost \\
Magnet + structure cost (single) (M USD) & totalSolenoidCostI & totalM1CostI \\
\hline
Total cost (M USD) & totalSolenoidCost & totalM1Cost \\
\hline
\end{tabular}}

...
\hline
Magnet Type & Copper & HTS CICC & HTS CICC \\
Radius (m) & 5.05 & 2.95 & 1.5 \\
dr (m) & 0.9 & 0.67 & 0.67 \\
dz (m) & 0.9 & 0.67 & 0.67 \\
Current supply (MA) & 5.4 & 13.0 & 13.0 \\
Conductor current density (A/mm$^2$) & 7.3 & 150.0 & 150.0 \\
Cable width (m) & - & 0.014 & 0.014 \\
Cable height (m) & - & 0.017 & 0.017 \\
Total volume (m$^3$) & 26.0 & 8.2 & 4.2 \\
Cross-sectional area (m$^2$) & 0.81 & 0.44 & 0.44 \\
Turn-turn Insulation Fraction & 0.1 & 0.0 & 0.0 \\
\hline
Cable turns & - & 1900.0 & 1900.0 \\
Total turns of conductor & 270000.0 & 1800.0 & 1800.0 \\
Length of conductor (km) & 8500.0 & 33.0 & 17.0 \\
Current per conductor (A) & 20.0 & 7200.0 & 7200.0 \\
\hline
Cost of REBCO tape(\$/kAm) & 50.0 & 50.0 & 50.0 \\
Cost of SC (M USD) & 0.0 & 12.0 & 6.2 \\
Cost of copper (M USD) & 1.9 & 0.21 & 0.1 \\
